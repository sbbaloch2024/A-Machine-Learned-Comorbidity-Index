...
pooling with LayerNorm as the set aggregation mechanism. Each admission's ICD-10
...
Running
-------
    python deepsets_weighted_mean_nhsic_multi_rbf_mimiciv.py --data_root /path/to/final_datasets

With optional arguments:
    python deepsets_weighted_mean_nhsic_multi_rbf_mimiciv.py \\
        --data_root /path/to/final_datasets \\
        --validity_mode intersection

Override training seed:
    SEED=42 python deepsets_weighted_mean_nhsic_multi_rbf_mimiciv.py --data_root /path/to/final_datasets

Example:
    python deepsets_weighted_mean_nhsic_multi_rbf_mimiciv.py --data_root ./data/final_datasets
"""
