...
data. Each admission's ICD-10 codes are embedded, transformed per-element via a
...
Running
-------
    python deepsets_attention_pooling_mimiciv.py --data_root /path/to/final_datasets

Override training seed:
    SEED=42 python deepsets_attention_pooling_mimiciv.py --data_root /path/to/final_datasets

Example:
    python deepsets_attention_pooling_mimiciv.py --data_root ./data/final_datasets
"""
