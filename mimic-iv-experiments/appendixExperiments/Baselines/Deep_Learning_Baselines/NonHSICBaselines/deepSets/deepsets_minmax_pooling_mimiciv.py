...
Running
-------
    python deepsets_minmax_pooling_mimiciv.py --data_root /path/to/final_datasets

Override training seed:
    SEED=42 python deepsets_minmax_pooling_mimiciv.py --data_root /path/to/final_datasets

Example:
    python deepsets_minmax_pooling_mimiciv.py --data_root ./data/final_datasets
"""
