...
Run the script with:
    ...
    python CCIECI_zsum_mimiciv.py --data_root /path/to/final_datasets

Override the seed:

    SEED=42 python CCIECI_zsum_mimiciv.py --data_root /path/to/final_datasets

Example:
    python CCIECI_zsum_mimiciv.py --data_root ./data/final_datasets
"""
