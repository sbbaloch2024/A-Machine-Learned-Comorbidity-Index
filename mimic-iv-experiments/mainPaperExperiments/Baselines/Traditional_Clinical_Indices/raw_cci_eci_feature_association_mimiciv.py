...
Evaluate the CORE test split:
    ...
    python raw_cci_eci_feature_association_mimiciv.py --data_root /path/to/final_datasets

Evaluate train, validation, and test splits:

    python raw_cci_eci_feature_association_mimiciv.py \
...
Example:
    python raw_cci_eci_feature_association_mimiciv.py --data_root ./data/final_datasets
"""
