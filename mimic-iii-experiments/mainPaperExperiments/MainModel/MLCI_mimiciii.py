...
of ICD-9 prefix tokens. Tokens are embedded, processed independently by a phi network, 
...
6.  Build a TRAIN-only ICD-9 prefix vocabulary:
...
Run the script with:
    ...
    python MLCI_mimiciii.py --data_root /path/to/final_datasets

Override the training seed:

    SEED=42 python MLCI_mimiciii.py --data_root /path/to/final_datasets

Example:
    python MLCI_mimiciii.py --data_root ./data/final_datasets
"""
