...
set of ICD-9 prefix tokens. Tokens are embedded, processed with Induced Set
...
7.  Build a TRAIN-only ICD-9 prefix vocabulary:
...
Run the script with:
    ...
    python set_transformer_mimiciii.py --data_root /path/to/final_datasets

Override the training seed:

    SEED=42 python set_transformer_mimiciii.py --data_root /path/to/final_datasets

Example:
    python set_transformer_mimiciii.py --data_root ./data/final_datasets
"""
