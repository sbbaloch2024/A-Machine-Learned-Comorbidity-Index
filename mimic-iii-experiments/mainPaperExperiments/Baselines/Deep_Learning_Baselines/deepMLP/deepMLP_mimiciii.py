...
binary cross-entropy (BCE) on clinical admission data. ICD-9 diagnosis codes are
...
Running
-------
    python deepMLP_mimiciii.py --data_root /path/to/final_datasets

Override training seed:
    SEED=42 python deepMLP_mimiciii.py --data_root /path/to/final_datasets

Example:
    python deepMLP_mimiciii.py --data_root ./data/final_datasets
"""
