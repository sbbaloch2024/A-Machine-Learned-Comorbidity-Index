...
Running
-------
    python nhsic_multi_rbf_settransformer_mimiciii.py --data_root /path/to/final_datasets

With optional arguments:
    python nhsic_multi_rbf_settransformer_mimiciii.py \\
        --data_root /path/to/final_datasets \\
        --validity_mode intersection

Override training seed:
    SEED=42 python nhsic_multi_rbf_settransformer_mimiciii.py --data_root /path/to/final_datasets

Example:
    python nhsic_multi_rbf_settransformer_mimiciii.py --data_root ./data/final_datasets
"""
