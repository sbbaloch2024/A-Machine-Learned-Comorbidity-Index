...
ICD-9 token embeddings and combines a factorization machine (FM) interaction term
...
Running
-------
    python DeepFM_mimiciii.py --data_root /path/to/final_datasets

Override training seed:
    SEED=42 python DeepFM_mimiciii.py --data_root /path/to/final_datasets

Example:
    python DeepFM_mimiciii.py --data_root ./data/final_datasets
"""
